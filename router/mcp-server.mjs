  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        signal: { type: "string",
          enum: ["tests_passed", "tests_failed", "escalated", "retried", "committed", "abandoned", "none"],
          description: "an OBSERVABLE fact about what happened, not a judgement. tests_passed/tests_failed if you ran tests; escalated if you fell back to a dearer model; retried if the task was attempted again; committed/abandoned if the diff was kept or dropped; none if nothing is observable. Do not guess — 'none' is excluded from the metric rather than assumed successful." },
...
async function callTool(name, args = {}) {
  ...
  if (name === "perdollar_report") {
    ...
    const rec = record({
      ...
      signal: args.signal && args.signal !== "none" ? args.signal : undefined,
